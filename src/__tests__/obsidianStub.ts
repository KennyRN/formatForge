...
export class Modal {
	app: App;
	modalEl = { addClass() {}, removeClass() {} } as unknown as HTMLElement;
	contentEl = {
		empty() {},
		addClass() {},
		createDiv() { return this as unknown as HTMLElement; },
		createEl() { return this as unknown as HTMLElement; },
	} as unknown as HTMLElement;
	titleEl = { remove() {}, setText() {} } as unknown as HTMLElement;

...
export class TextStyleModal extends Modal {
	...
	private renderFontCard(
		...
		renderCustomFontCard({
			...
			overrideFontKey: overrideFontKey as string,
			fontWeightKey: fontWeightKey as string,
			fontFamilyKey: fontFamilyKey as string,
			smallCapsKey: smallCapsKey as string | undefined,
			previewFontSizeEm,
